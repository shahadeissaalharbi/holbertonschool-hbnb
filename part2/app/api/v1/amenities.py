...
amenity_model = api.model('Amenity', {
    ...
    'description': fields.String(required=False, description='Description of the amenity') # Added to match diagram
})
...
class AmenityList(Resource):
    ...
    def get(self):
        ...
        return [{'id': a.id, 'name': a.name, 'description': a.description} for a in amenities], 200
